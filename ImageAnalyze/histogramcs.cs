...
{
    public partial class Histogramcs : Form
    {
        public Histogramcs()
        {
            InitializeComponent();
        ...
        private void histogramcs_Paint(object sender, PaintEventArgs e)
        {
                //画出坐标系
        ...
        private void histogramcs_Load(object sender, EventArgs e)
        {
            //将图像数据复制到byte中
